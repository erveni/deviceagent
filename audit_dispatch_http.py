...
_RANK_PROMPT_BODY = (
    ...
    "actual total that genuinely rank; continue inspecting results until the total is known, or give "
    "a best-supported complete-market estimate when the UI is partial. The total normally exceeds 3 "
    "and may be dozens. Never use the number of summarized lines as Y, and never output 3/3 or 4/4 merely because only three "
    ...
    "If the complete total cannot be fully enumerated, provide the best-supported approximate numeric "
    "total from visible results and label it approximate; never output UNVERIFIED. If the target is "
    "absent and the current ranking estimate is Y businesses, append it as last using X=Y+1 and "
    "total=Y+1. Never use a fixed default such as 8/8. "
